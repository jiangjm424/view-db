...
import com.db.view.databinding.LayoutDataFooterBinding
import com.db.view.extfuns.toNumericString
import com.db.view.widget.FooterTextView
...
class DataFooterAdapter(private val layoutWidth: Int, private val screenWidth: Int, private val block: () -> Int) : RecyclerView.Adapter<DataFooterAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val footerBinding = LayoutDataFooterBinding.inflate(LayoutInflater.from(context), parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        val text = if (recordCount > 1) {
            context.resources.getString(R.string.database_records_loaded)
        } else {
            context.resources.getString(R.string.database_record_loaded)
        }
